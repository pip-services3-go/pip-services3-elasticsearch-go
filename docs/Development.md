# Development and Testing Guide <br/> Pip.Services Elasticsearch for Golang
...
If you are planning to develop and test you may need to install ElasticSearch servers:
- Download and install ElasticSeearch from https://www.elastic.co/

## <a name="install"></a> Installing

After your environment is ready you can check out source code from the Github repository:
```bash
git clone git@github.com:pip-services/pip-services-elasticsearch-go.git
```
